...
def app():
    ...
    st.write(text)  
    st.markdown("Baldevarona, A. M. G., Banggud, R. B., Gronifillo, G. C., Honrado, S. R. B., & Jamelarin,  R. J. E. L. *E-banking usage level and influence on spending habits among College of Business and Management students.* (2024)")
